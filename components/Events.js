	...
	return (
		<div className='w-full flex flex-col items-center py-[60px] px-[20px]'>
			<Link href='/create/event'>
				<button className='bg-[#fdc56c] border-[1px] px-6 py-4 rounded-lg mb-4'>
			...
			<div className='w-full flex flex-wrap items-center justify-center'>
				{events.map((event) => (
					...
					>
						...
						<div className='w-full py-6 bg-[#fdc56c] rounded-b-2xl flex items-center px-4 justify-between'>
